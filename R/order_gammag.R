#' Random Sampling of k-th Order Statistics from a Gamma Uniform G Distribution
#'
#'\code{order_gammag} is used to obtain a random sample of the k-th order statistic from a Gamma Uniform G distribution.
...
#' @return A list with a random sample of order statistics from a Gamma Uniform G Distribution, the value of its join probability density function evaluated in the random sample
