...
#' @return A list with a random sample of order statistics from a Gamma Uniform G Distribution, the value of its join probability density function evaluated in the random sample and
...
#' order_gammag(10,"exp",1,k=3,50,alpha=0.02)
...
order_gammag <- function(size,spec,a,k,n,alpha=0.05,...){
