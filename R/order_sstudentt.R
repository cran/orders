#' Random Sampling of Order Statistics from a Skew student t Distribution
#'
#'\code{order_sstudentt} is used to obtain a random sample of order statistics from a Skew student t Distribution.
...
#' @return A list with a random sample of order statistics from a Skew student t Distribution and the value of its join probability density function evaluated in the random sample.
...
#' order_sstudentt(size=10,k=3,mu=0,sigma=1,nu=0,tau=2,n=30)
#' @importFrom gamlss.dist qST1 dST1
#' @importFrom stats rbeta
#' @export order_sstudentt

order_sstudentt <- function(size,k,mu,sigma,nu,tau,n,...){
