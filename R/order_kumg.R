...
#' @return A list with a random sample of order statistics from a Kumaraswamy G Distribution, the value of its join probability density function evaluated in the random sample and
...
#' order_kumg(10,"exp",1,1,k=3,50,alpha=0.02)
#' # A sample of size 10 of the 3-th order statistics from
...
order_kumg <- function(size,spec,a,b,k,n,alpha=0.05,...){
