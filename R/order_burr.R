...
#' @return A list with a random sample of order statistics from a Burr Distribution, the value of its join probability density function evaluated in the random sample and
...
#' order_burr(size=10,shape1=0.75,shape2=1,scale=0.5,k=3,n=50,alpha=0.02)
#' @importFrom actuar qburr dburr
#' @importFrom stats rbeta
#' @export order_burr

order_burr <- function(size,k,shape1,shape2,scale,n,alpha=0.05,...){
