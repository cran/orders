...
#' @return A list with a random sample of order statistics from a Beta Extended G Distribution, the value of its join probability density function evaluated in the random sample and
...
order_beg <- function(size,spec,a,b,k,n,alpha=0.05,...){
