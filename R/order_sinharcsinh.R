...
#'
#' @return A list with a random sample of order statistics from a Sinh-Arcsinh Distribution, the value of its join probability density function evaluated in the random sample and
...
#' order_sinharcsinh(size=10,k=3,mu=0,sigma=1,nu=1,tau=2,n=30,alpha=0.02)
#' @importFrom gamlss.dist qSHASH dSHASH
#' @importFrom stats rbeta
#' @export order_sinharcsinh

order_sinharcsinh <- function(size,k,mu,sigma,nu,tau,n,alpha=0.05,...){
