...
#'
#'\code{order_expg} is used to obtain a random sample of order statistics from a Exponentiated G Distribution.
...
#' @return A list with a random sample of order statistics from a Exponentiated G Distribution and the value of its join probability density function evaluated in the random sample.
