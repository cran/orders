...
#' @return A list with a random sample of order statistics from a Sichel Distribution, the value of its join probability density function evaluated in the random sample and
...
#' # order_sichel(size=20,k=5,mu=5,sigma=1,nu=1,n=30,alpha=0.02)
#' @importFrom gamlss.dist qSICHEL dSICHEL
#' @importFrom stats rbeta

order_sichel <- function(size,k,mu,sigma,nu,n,alpha=0.05,...){
